  ...
  return (
    <>
      <div className='w-full h-screen flex flex-col justify-start gap-12 items-center'>
        <NavMenu />
        <main className='w-11/12 lg:h-[500px] flex-1 gap-4 sm:flex lg:flex-row  flex flex-col  sm:justify-center items-center sm:border sm:border-green-200 sm:rounded-lg '>
          <div className='mx-auto  sm:pt-16 sm:pb-20 text-center lg:py-48 lg:text-left'>
            <div className='sm:justify-center lg:justify-start md:justify-center'>
              <img className='mx-0 lg:h-40  w-auto' src='/logo192.ico' alt='HrNet' />
            </div>
            <div className='px-4 sm:px-8 lg:w-11/12 xl:pr-16'>
              <h1 className='text-xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl'>
                <span className='block xl:inline'>HRNet the app that manage</span>{' '}
